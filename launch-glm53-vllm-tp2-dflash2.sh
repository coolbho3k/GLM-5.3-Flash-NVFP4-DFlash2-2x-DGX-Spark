...
docker run --gpus all -d \
  ...
  -e EXL3_FAT_PIPELINE="${EXL3_FAT_PIPELINE:-off}" \
  -e EXL3_FAT_PIPELINE_CONTROL="${EXL3_FAT_PIPELINE_CONTROL:-}" \
  -e GLM53_EXL3_MOE_FAST="${GLM53_EXL3_MOE_FAST:-0}" \
  -e GLM53_EXL3_MOE_STREAM_WEIGHTS="${GLM53_EXL3_MOE_STREAM_WEIGHTS:-0}" \
