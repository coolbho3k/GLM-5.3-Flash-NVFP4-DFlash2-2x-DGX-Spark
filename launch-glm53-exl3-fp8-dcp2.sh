...
export IMAGE="${IMAGE:-glm53-exl3:e3-fp8-dcp2}"
...
export EXL3_FAT_GROUPED="${EXL3_FAT_GROUPED:-1}"
export EXL3_TEMP_ROWS_FUSED="${EXL3_TEMP_ROWS_FUSED:-64}"
export GLM53_SPINWAIT_MS="${GLM53_SPINWAIT_MS:-16}"
